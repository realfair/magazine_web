<footer id="footer">
	...
	<div class="footer-menu">
		<div class="container">
			<ul class="nav navbar-nav">                       
				...
				<li><a href="#">Ibyegeranyo</a></li>
				<li><a href="#">Ubugeni</a></li>
				<li><a href="#">Ubucukumbuzi</a></li>
				<li><a href="#">Ikoranabuhanga</a></li>
				<li><a href="#">Isoko</a></li>
				<li><a href="#">Amashusho</a></li>
			</ul> 
		</div>
	</div>
	<div class="bottom-widgets">
		<div class="container">
			<div class="col-sm-4">
				<div class="widget">
					<h2>Ibyegeranyo / Ubucukumbuzi</h2> 
					<ul>
	...
	<div class="footer-bottom">
		<div class="container text-center">
			<p><a href="#">Copyright </a>&copy; <?php echo date('Y'); ?> All right Reserved to RedBue JD. </p>
		</div>
	</div>		
</footer>